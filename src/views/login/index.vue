       ...
       <div class="login-wrap">
            ...
            <el-form-item  prop="password" class="item-from">
             ...
             <el-form-item  prop="passwords" class="item-from" v-show ="modal === 'register'">
                <label>重复密码：</label>
                <el-input type="password" v-model="ruleForm.passwords" auto-complete="off" maxlength = '20' minlength='6'></el-input>
            </el-form-item>
...
import  { setCookie ,setUsername,setRole,setInfo } from '@/utils/cookie'
         ...
         let data = {
                 ...
                 Login(data).then((res)=>{
                   if(res.data.code =='200'){
                     ...
                     setInfo('userId',res.data.userId)
                     this.$store.commit('Login/set_Token',res.data.token)
                     this.$store.commit('Login/set_userName',res.data.username)
