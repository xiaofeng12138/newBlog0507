           ...
           <div class="nav">
            <el-row :gutter="10">
                ...
                <el-submenu index="exhibition">
                    <template slot="title">前端学习</template>
                    <el-menu-item index="JCinfo">基础</el-menu-item>
                    <el-menu-item index="JSinfo">JS</el-menu-item>
                    <el-menu-item index="KJinfo">框架</el-menu-item>
                    <el-menu-item index="studyInfo">资源分享</el-menu-item>
                </el-submenu>
                
                <el-menu-item index="lifeInfo">生活随笔</el-menu-item>
                <el-menu-item index="messageInfo">留言板</el-menu-item>
...
<script>
import {getCookie,getUsername,removeCookie,removeUsername,getRole,setRole,getInfo} from '@/utils/cookie';
